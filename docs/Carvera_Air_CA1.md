# Carvera Air CA1 Hardware Reference
...
|-------------|----------|---------|------------|---------------------|------------|
| X (alpha)   | 1.28     | 1.29    | 0.1        | 640                 | 500 mm     |
| Y (beta)    | 1.26     | 1.27!   | 0.0        | 640                 | 380 mm     |
| Z (gamma)   | 1.24     | 1.25    | 3.25       | 640                 | 150 mm     |
| A (delta)   | 1.21     | 1.23!   | 1.30       | 888.889 (steps/deg) | 380°       |
| B (epsilon) | 1.22     | 1.0     | 1.10       | 888.889             | -          |
...
|------|---------|---------|------------------|---------|
| X    | 0.24^   | 0.24^   | home_to_max      | 2 mm    |
| Y    | 0.25^   | 0.25^   | home_to_max      | 2 mm    |
| Z    | 1.1^    | 1.1^    | home_to_max      | 2 mm    |
| A    | 1.9^    | 1.9^    | home_to_min      | 0.5 mm  |
...
|-------------------------|------|--------------|-----------|
| E-Stop                  | 0.20 | yes          | no        |
| Cover/Lid               | 1.8  | yes          | yes       |
| Main Button             | 2.13 | yes          | yes       |
| Probe (wireless)        | 2.6  | voltage mode | no        |
| Tool Setter (calibrate) | 0.5  | yes          | no        |
| EXT Input               | 0.21 | -            | momentary |
...
|-------------|------|------------|-------------------|
| Spindle     | P2.5 | PWM1.6     | 10000 µs (100 Hz) |
...
| PSU Thermistor     | P0.26 | AD0.3      | 100kΩ NTC, β=3950 |
...
|------|----------|----------|------------|-------------|-------------|
| X    | -295     | 0        | 500 mm     | 15 mm/s     | 3 mm/s      |
| Y    | -205     | 0        | 380 mm     | 15 mm/s     | 3 mm/s      |
| Z    | -110     | 0        | 150 mm     | 10 mm/s     | 3 mm/s      |
...
| Parameter        | X      | Y      | Z    |
|------------------|--------|--------|------|
| Anchor 1         | -291.0 | -203.0 | -    |
| Anchor 2 Offset  | +88.5  | +45.0  | -    |
| Tool Rack Offset | +126   | +196   | -108 |
| Tool Setter      | -165.0 | +173.0 | -148 |
...
|---------------------|-------------|
| Threshold Temp      | 20°C        |
| Cooldown Power Init | 20%         |
| Cooldown Power Step | 2.5% per °C |
| Cooldown Delay      | 180 s       |
