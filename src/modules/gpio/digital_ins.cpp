...
DigitalIns::DigitalIns(const uint8_t num_pins, const inputPin_t pins[], const SerialComms* comms)
    : comms(comms),
      num_pins(num_pins),
...
bool DigitalIns::listens_to_rx() { return true; }
