...
CNC conversion using Carvera C1 controller board running electrophorus firmware. Ignore this; it is the author's
personal project - he got hold of a half-broken C1 board and is messing around with it.
...
With a single SPDT button (NC/C/NO), use C-NC for the relay and take status from a spare relay contact. Use a relay with
2 NO contacts (DPDT like JQX-13F or HH52P).
