...
class Stepgen {
 public:
  ...
  void update(double period_s, linuxCncState_t &linuxcnc_state);
  void apply_feedback(const pruState_t &pru_state);
  void reset_prev_feedback(const pruState_t &pru_state);
