...
void Stepgen::update(const double period_s, linuxCncState_t &linuxcnc_state) {
...
void Stepgen::apply_feedback(const pruState_t &pru_state) {
...
void Stepgen::reset_prev_feedback(const pruState_t &pru_state) { prev_feedback = pru_state.stepgen_feedback[index]; }
